(function() {
  ...
  test('test_date', function() {
    var base, data_source1, date_axis, div, interval, old_axis, pantool, plot1, scatterrenderer, selectoverlay, selecttool, zoomtool;
    expect(0);
    ...
    date_axis = Bokeh.Collections['D3LinearDateAxis'].create(old_axis.attributes, {
      'local': true
    });
